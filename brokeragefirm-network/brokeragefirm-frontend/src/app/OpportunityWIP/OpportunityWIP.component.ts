...
import { OpportunityWIPService } from './OpportunityWIP.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-opportunitywip',
  templateUrl: './OpportunityWIP.component.html',
  styleUrls: ['./OpportunityWIP.component.css'],
  providers: [OpportunityWIPService]
})
export class OpportunityWIPComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceOpportunityWIP.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceOpportunityWIP.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceOpportunityWIP.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceOpportunityWIP.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceOpportunityWIP.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
