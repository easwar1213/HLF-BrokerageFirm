...
describe('CreateLeadComponent', () => {
  ...
  let mockCreateLeadService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateLeadService = sinon.createStubInstance(CreateLeadService);
    mockCreateLeadService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateLeadService, useValue: mockCreateLeadService },
