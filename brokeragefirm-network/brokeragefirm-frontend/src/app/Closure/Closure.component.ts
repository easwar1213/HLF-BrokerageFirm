...
export class ClosureComponent implements OnInit {
  ...
  constructor(private serviceClosure: ClosureService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceClosure.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.example.brokeragefirmnetwork.Closure',
    ...
    return this.serviceClosure.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceClosure.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceClosure.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceClosure.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
